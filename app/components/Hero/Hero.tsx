...
const Hero = () => {
    ...
    return (
        <section className="flex flex-col items-center justify-center min-h-[90vh] w-full max-w-[1200px] mx-auto pb-10 relative">
            ...
            {lgScreen < 1024 && (
                <Link href={'/Resume.pdf'} download className="absolute right-5 top-5 p-3 px-8 text-xl font-medium text-cyan-400 underline decoration-cyan-400/50 hover:text-white transition-colors duration-300">
                    Download CV
                </Link>
            )}
            ...
            <div className="w-full flex gap-12 max-md:flex-col items-center justify-between z-10 p-10 max-sm:p-5">
                <div className="flex flex-col w-[60%] max-md:w-full">
                    ...
                    >
                        ...
                        {lgScreen >= 1024 && (
                            <Link href={'/Resume.pdf'} download className="overflow-hidden gap-2 self-start px-8 py-3.5 text-lg font-medium leading-none whitespace-nowrap rounded-lg border border-cyan-500/50 text-white hover:bg-cyan-500/10 hover:border-cyan-400 duration-300">
                                Download CV
                            </Link>
                        )}
                    </motion.div>
